...
_stroke_dir = Path('/Users/francescalim/Desktop/stroke_model')
...
OUTPUT = _stroke_dir/'outputs'
# GRAPH_OUTPUT = OUTPUT/'maps'
LOCAL_OUTPUT = OUTPUT/'stroke_output_pid_250' # where data files exist
BASIC_ANALYSIS_OUTPUT = OUTPUT/'analyzed_output_pid_250_110420' # output of analyzed files
