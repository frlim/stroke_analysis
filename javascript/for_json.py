...
for race_score in range(10):
    ...
    output_path = stroke_path/'output/after_data'
    out_fname = f'times=MA_n=100_hospitals=MA_n=100_random_male_RACE_{race_score}_s=20000.csv'
    ...
    file = open(out_path/f'MA_n=100_lines_RACE_{race_score}_s=20000.json','w+')
